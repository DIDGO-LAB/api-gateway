...
- `user-service-openapi`: `/user-service/v3/api-docs`, `/user-service/v3/api-docs/**`
- `training-service-openapi`: `/training-service/v3/api-docs`, `/training-service/v3/api-docs/**`
